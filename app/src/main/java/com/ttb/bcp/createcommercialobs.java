...
public class createcommercialobs extends AppCompatActivity {
    ...
    File file;
    Uri file_uri;
    static final String TAG="commercial";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_createcommercialobs);
        ...
        title_toolbar.setText("COMMERCIAL (OBS)");
        category = (Spinner) findViewById(R.id.complaintCategory);

        complaintAdapter = ArrayAdapter.createFromResource(this, R.array.commercialArray, android.R.layout.simple_spinner_item);
        ...
        profile_toolbar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (encoded_string.length()>5 && name.getText().toString().length()>1 && message.getText().toString().length()>1){
                    registerRequest2();
                }else{
                    Toast.makeText(createcommercialobs.this, "Please enter all the values.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void registerRequest2() {
        final ProgressDialog pd = new ProgressDialog(createcommercialobs.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, new functions().baseIP+"createcommercial.php", jsonObject,
...
//        till here
    ...
    private void registerRequest() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, new functions().baseIP+"createcommercial.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.equals("success")){
                            new functions().exitDialog(createcommercialobs.this,"Success","You have successfully registered your observation on our platform. We will contact you shortly","ok");
                        }else{
                            new functions().normalDialog(createcommercialobs.this,"Error","We could not register your request at this moment. Please try again later.","ok");
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                pd.dismiss();
                Toast.makeText(createcommercialobs.this, "Errror: Image might be too large.", Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("placename",name.getText().toString().trim().replaceAll(" ","%20"));
    ...
    private class encode_image extends AsyncTask<Void,Void,Void> {
        ...
        protected void onPreExecute() {
            pd= new ProgressDialog(createcommercialobs.this);
