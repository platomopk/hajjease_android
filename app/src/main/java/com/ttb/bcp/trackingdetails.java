...
public class trackingdetails extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trackingdetails);
        ...
        title_toolbar.setText("Track Family");
            ...
            case 101:
                switch (resultCode) {
                    case Activity.RESULT_OK:
                        ...
                        Toast.makeText(trackingdetails.this, states.isLocationPresent() + "", Toast.LENGTH_SHORT).show();
                        break;
                    case Activity.RESULT_CANCELED:
                        // The user was asked to change settings, but chose not to
                        Toast.makeText(trackingdetails.this, "Canceled", Toast.LENGTH_SHORT).show();
                        break;
                    default:
                        break;
                }
...
//            mapboxMap.selectMarker(myCurrentLocationMarker);
    ...
    Bitmap bitmap=null;
    Icon getUserIcon() {
        IconFactory iconFactory = IconFactory.getInstance(trackingdetails.this);
...
//                            try {
//                                Toast.makeText(trackingdetails.this, "ICON LOADED", Toast.LENGTH_SHORT).show();
...
//                                                setIcon(IconFactory.getInstance(trackingdetails.this).fromBitmap(bitmap))
//
//                                        );
//                                Toast.makeText(trackingdetails.this, IconFactory.getInstance(trackingdetails.this).fromBitmap(bitmap).getScale()+"", Toast.LENGTH_SHORT).show();
//                            } catch (JSONException e) {
//                                e.printStackTrace();
//                            }
//                        }
